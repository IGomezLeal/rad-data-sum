...
1. [**1. Bolometric Dimming**](./proyecto1.md) — Hardcoded parameterizations of non-spectral solar constant reductions.
2. [**2. Spectral Dimming**](./proyecto2.md) — Radiative transfer integrations of Lagrangian L1 space filters.
3. [**3. 4D Matrix Simulation**](./proyecto3.md) — 4D numerical array embedding for time-space-wavelength dynamic forcing.
